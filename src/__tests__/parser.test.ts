// Use dynamic imports to avoid CommonJS/ESM compatibility issues
let parse: any, serialize: any;

beforeAll(async () => {
  const rainbow = await import('@plutojl/rainbow');
  parse = rainbow.parse;
  serialize = rainbow.serialize;
});
...
`;
      ...
      expect(result.cell_order).toContain('aaa11111-2222-3333-4444-555566667777');
      expect(result.cell_order).toContain('bbb22222-3333-4444-5555-666677778888');
      expect(result.cell_inputs['aaa11111-2222-3333-4444-555566667777']).toBeDefined();
      expect(result.cell_inputs['bbb22222-3333-4444-5555-666677778888']).toBeDefined();
    });
...
`;
      ...
      expect(result.cell_order).toContain('md111111-2222-3333-4444-555566667777');
...
`;
      ...
      expect(result.cell_inputs['ddd44444-4444-4444-4444-444444444444']).toBeDefined();
      expect(result.cell_inputs['ddd44444-4444-4444-4444-444444444444'].code).toContain('begin');
      expect(result.cell_inputs['ddd44444-4444-4444-4444-444444444444'].code).toContain('end');
    });
...
`;
      ...
      expect(result.cell_inputs['abc12345-1234-5678-9abc-def012345678']).toBeDefined();
      expect(result.cell_inputs['def67890-5678-9abc-def0-123456789abc']).toBeDefined();
...
`;
      ...
      expect(result.cell_order).toContain('eee55555-5555-5555-5555-555555555555');
    });
  });
...
`;
      ...
      expect(parsed.cell_inputs['fff66666-6666-6666-6666-666666666666']).toBeDefined();
      expect(parsed.cell_inputs['ggg77777-7777-7777-7777-777777777777']).toBeDefined();
      ...
      expect(Object.keys(reParsed.cell_inputs)).toEqual(Object.keys(parsed.cell_inputs));
    });
...
`;
      ...
      expect(parsed.cell_order).toEqual(['ccc88888-8888-8888-8888-888888888888', 'aaa99999-9999-9999-9999-999999999999', 'bbbaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa']);

      const serialized = serialize(parsed);
      const reParsed = parse(serialized);

      expect(reParsed.cell_order).toEqual(['ccc88888-8888-8888-8888-888888888888', 'aaa99999-9999-9999-9999-999999999999', 'bbbaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa']);
    });
  });
